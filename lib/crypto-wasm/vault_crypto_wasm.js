/* @ts-self-types="./vault_crypto_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function decryptEntry(encrypted_data_hex, nonce_hex, key_hex) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(encrypted_data_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.decryptEntry(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {string}
 */
export function decryptRaw(ciphertext_hex, nonce_hex, key_hex) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr2 = passStringToWasm0(key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.decryptRaw(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
export function deriveEncryptionKey(password, salt) {
    ...
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.deriveEncryptionKey(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @returns {any}
 */
export function encryptEntry(entry_json, key_hex) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encryptEntry(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function encryptRaw(plaintext_hex, key_hex) {
    const ptr0 = passStringToWasm0(plaintext_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encryptRaw(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function generateEncryptionSalt() {
    ...
    let deferred2_1;
    try {
        const ret = wasm.generateEncryptionSalt();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function generatePassword(length, lowercase, uppercase, digits, symbols) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.generatePassword(length, lowercase, uppercase, digits, symbols);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function generateSharedVaultKey() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.generateSharedVaultKey();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
...
export function generateX25519Keypair() {
    const ret = wasm.generateX25519Keypair();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function hashMasterPassword(password) {
    const ptr0 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.hashMasterPassword(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function verifyMasterPassword(password, hash) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verifyMasterPassword(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
 ...
 * @returns {string}
 */
export function x25519DeriveSharedKey(private_key_hex, public_key_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.x25519DeriveSharedKey(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./vault_crypto_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        throw new Error('WASM module path is required in React Native — use initSync() instead');
    }
    const imports = __wbg_get_imports();
